...
do
  ...
  local bad_origins = registry.route(
    with_req {
      Action = "RegisterSite",
  ...
  local bad_methods = registry.route(
    with_req {
      Action = "RegisterSite",
  ...
  local bad_profile = registry.route(
    with_req {
      Action = "RegisterSite",
  ...
  local bad_schema = registry.route(
    with_req {
      Action = "RegisterSite",
  ...
  local oversize_cfg = registry.route(
    with_req {
      Action = "RegisterSite",
      ["Site-Id"] = "site-big",
      Config = big_cfg,
  ...
  local cleared_get = registry.route(
    with_req {
      Action = "GetResolverFlags",
      ["Resolver-Id"] = "resolver-1",
      ["Actor-Role"] = "registry-admin",
...
do
  ...
  local publish_empty = site.route(
    with_req {
      Action = "PublishVersion",
      ["Site-Id"] = "site-2",
      Version = "v1",
  ...
  local archive_extra = site.route(
    with_req {
      Action = "ArchivePage",
      ["Site-Id"] = "site-2",
      ["Page-Id"] = "old",
  ...
  local archive_long_version = site.route(
    with_req {
      Action = "ArchivePage",
      ["Site-Id"] = "site-2",
      ["Page-Id"] = "old",
...
do
  ...
  local oversize_payload = catalog.route(
    with_req {
      Action = "UpsertProduct",
      ["Site-Id"] = "site-1",
      Sku = "sku-big",
  ...
  local publish_conflict = catalog.route(
    with_req {
      Action = "PublishCatalogVersion",
      ["Site-Id"] = "site-1",
      Version = "cat-v2",
...
do
  ...
  local long_asset_resp = access.route(
    with_req {
      Action = "GrantEntitlement",
      Subject = "user-long",
      Asset = long_asset,
  ...
  local oversize_policy = access.route(
    with_req {
      Action = "GrantEntitlement",
      Subject = "u5",
